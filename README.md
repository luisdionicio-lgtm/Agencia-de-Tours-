...
- Selector principal con los 17 tours, flechas y pestañas horizontales por nombre para descubrir y abrir cualquier paquete desde la portada sin cambios inesperados de imagen.
...
- Oxapampa–Pozuzo utiliza como portada una experiencia cultural con viajeros y presenta una galería propia de tres momentos: comunidad local, catarata de selva alta y pórtico tradicional.
...
- Auditoría visual de las fotografías públicas: se retiraron el logotipo y la etiqueta «Archivo propio» de Ica–Huacachina, Tarapoto y Oxapampa–Pozuzo; las tarjetas conservan un encuadre panorámico 16:9 centrado y las galerías no superponen información de procedencia sobre el material turístico.
...
- Paquete principal integrado «Cusco, Puno y Arequipa» de 7 días / 6 noches: reúne Cusco, Valle Sagrado, Machu Picchu, Puno, lago Titicaca y Arequipa en una sola propuesta nacional. La ficha pública muestra solo las etapas principales; el itinerario operativo completo, inclusiones y exclusiones se desbloquean en la confirmación y permanecen en la constancia PDF.
- Biblioteca publicitaria de 17 modalidades consolidadas después de revisar 121 documentos del disco E: Cusco, Andes del sur, Tarapoto, norte del Perú, Ecuador, Colombia, Brasil, Argentina, Caribe, Disney y Europa. Se eliminaron duplicados y versiones repetidas.
...
- Catálogo de 17 propuestas reservables: las quince rutas existentes y dos programas adicionales para Cusco–Ica–Lima 2027 y Punta Sal con norte cultural.
- Programas comparados por temporada y versión: se toma el año de viaje más reciente y no únicamente la fecha de modificación del archivo. El contenido público elimina nombres de instituciones, datos personales, horarios operativos sensibles y condiciones internas.
- Fotografías referenciales optimizadas y almacenadas localmente; los créditos externos se conservan debajo de la imagen cuando corresponden, nunca superpuestos como marca de agua. Punta Sal utiliza una fotografía CC BY 3.0 de Wikimedia Commons, recortada para web y sin metadatos. No se reutilizaron imágenes europeas de procedencia incierta.
