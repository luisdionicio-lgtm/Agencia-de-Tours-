    ...
    <section className="airline-guide px-4 py-16 lg:px-6" aria-labelledby="airline-guide-title">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="airline-land-note">
          ...
          <div><strong>Ica, Oxapampa y Pozuzo: conexión terrestre</strong><p>Nuestro asesor puede ayudarte a coordinar el traslado desde Lima como parte de la planificación del tour.</p></div>
